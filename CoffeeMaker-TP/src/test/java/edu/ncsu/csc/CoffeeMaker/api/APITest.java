...
/**
 * A Test class for the Ingredint, invetory, and Recipe API calls. 
 * 
 * @author Meles Meles
 * @author Harris Khan 
 *
...
public class APITest {
    ...
    public void testApiUpdateInventoryAndMakeCofee () throws Exception {
        ...
        // Test getting invetory 
        mvc.perform( get( "/api/v1/inventory" ).contentType( MediaType.APPLICATION_JSON )).andExpect( status().isOk() );
